...
User.create!( 
  ...
  password: 'password',
  avatar: File.open("#{Rails.root}/public/seeds_image/user_image1.jpg"),
...
User.create!( 
  ...
  password: 'password',
  avatar: File.open("#{Rails.root}/public/seeds_image/user_image2.jpg"),
...
User.create!( 
  ...
  password: 'password',
  avatar: File.open("#{Rails.root}/public/seeds_image/user_image3.jpg"),
...
User.create!( 
  ...
  password: 'password',
  avatar: File.open("#{Rails.root}/public/seeds_image/user_image4.jpg"),
...
User.create!( 
  ...
  password: 'password',
  avatar: File.open("#{Rails.root}/public/seeds_image/user_image5.png"),
...
User.create!( 
  ...
  password: 'password',
  avatar: File.open("#{Rails.root}/public/seeds_image/user_image6.jpg"),
  sauna_career: "2018-11-01", 
...
User.create!( 
  ...
  password: 'password',
  avatar: File.open("#{Rails.root}/public/seeds_image/user_image7.jpg"),
...
User.create!( 
  ...
  password: 'password',
  avatar: File.open("#{Rails.root}/public/seeds_image/user_image8.jpg"),
...
User.create!( 
  ...
  password: 'password',
  avatar: File.open("#{Rails.root}/public/seeds_image/user_image9.jpg"),
...
User.create!( 
  ...
  password: 'password',
  avatar: File.open("#{Rails.root}/public/seeds_image/user_image10.jpg"),
  sauna_career: "2020-02-01", 
  home_sauna: 'スカイスパYOKOHAMA', 
  prefecture_id: 14,
...
User.create!( 
  ...
  password: 'password',
  avatar: File.open("#{Rails.root}/public/seeds_image/user_image11.jpg"),
...
User.create!( 
  ...
  password: 'password',
  avatar: File.open("#{Rails.root}/public/seeds_image/user_image12.jpg"),
...
User.create!( 
  ...
  password: 'password',
  avatar: File.open("#{Rails.root}/public/seeds_image/user_image13.jpg"),
...
User.create!( 
  ...
  password: 'password',
  avatar: File.open("#{Rails.root}/public/seeds_image/user_image14.jpg"),
...
User.create!( 
  ...
  password: 'password',
  avatar: File.open("#{Rails.root}/public/seeds_image/user_image15.jpg"),
  sauna_career: "2020-12-01", 
...
Food.create!(
  ...
  image: File.open("#{Rails.root}/public/seeds_image/ラクーア_カレーうどん.jpg"),
  user_id: 2
)
Food.create!(
  name: "焼肉定食",
  ...
  image: File.open('#{Rails.root}/public/seeds_image/しきじ_焼肉定食.jpg'),
  user_id: 2
)
Food.create!(
  name: "唐揚げ",
  ...
  image: File.open('#{Rails.root}/public/seeds_image/北欧_唐揚げ.jpg'),
  user_id: 2
)
Food.create!(
  name: "スンドゥブ",
  ...
  image: File.open('#{Rails.root}/public/seeds_image/スパロイヤル川口_スンドゥブ.jpg'),
  user_id: 3
)
Food.create!(
  name: "パワーアップ豚焼き",
  ...
  image: File.open('#{Rails.root}/public/seeds_image/草加健康センター_パワーアップ豚焼き.jpeg'),
  user_id: 2
)
Food.create!(
  name: "酸辣湯麺",
  ...
  image: File.open('#{Rails.root}/public/seeds_image/草加健康センター_酸辣湯麺.jpg'),
  user_id: 4
)
Food.create!(
  name: "麻婆豆腐定食",
  ...
  image: File.open('#{Rails.root}/public/seeds_image/草加健康センター_麻婆豆腐定食.jpg'),
  user_id: 6
)
Food.create!(
  name: "マグロ納豆",
  ...
  image: File.open('#{Rails.root}/public/seeds_image/草加健康センター_マグロ納豆.jpg'),
  user_id: 3
)
Food.create!(
  name: "カレーライス",
  ...
  image: File.open('#{Rails.root}/public/seeds_image/天空のアジト マルシンスパ_カレーライス.jpg'),
  user_id: 14
)
Food.create!(
  name: "笹塚チャーシューセット",
  ...
  image: File.open('#{Rails.root}/public/seeds_image/天空のアジト マルシンスパ_笹塚チャーシューセット.jpg'),
  user_id: 7
)
Food.create!(
  name: "唐揚定食",
  ...
  image: File.open('#{Rails.root}/public/seeds_image/かるまる_唐揚定食.jpg'),
  user_id: 11
)
Food.create!(
  name: "親子丼",
  ...
  image: File.open('#{Rails.root}/public/seeds_image/かるまる_親子丼.jpg'),
  user_id: 2
)
Food.create!(
  name: "十勝豚ロースカツカレー",
  ...
  image: File.open('#{Rails.root}/public/seeds_image/かるまる_十勝豚ロースカツカレー.jpg'),
  user_id: 11
)
...
Food.create!(
  ...
  image: File.open('#{Rails.root}/public/seeds_image/武蔵野温泉 なごみの湯_カレイの唐揚げ定食.jpg'),
  user_id: 4
)
...
Food.create!(
  ...
  image: File.open('#{Rails.root}/public/seeds_image/サウナと天然温泉 湯らっくす_四川風麻婆豆腐.jpg'),
  user_id: 2
)
...
Food.create!(
  ...
  image: File.open('#{Rails.root}/public/seeds_image/サウナと天然温泉 湯らっくす_酸辣湯.jpg'),
  user_id: 8
)
...
Food.create!(
  ...
  image: File.open('#{Rails.root}/public/seeds_image/サウナと天然温泉 湯らっくす_カツ丼.jpeg'),
  user_id: 8
)
...
Food.create!(
  ...
  prefecture_id: 14,
  description: "鶏ガラスープをベースにあっさり、ピリ辛に仕上げてあり食欲倍増",
  image: File.open('#{Rails.root}/public/seeds_image/スカイスパYOKOHAMA_キムチチゲ鍋.jpg'),
  user_id: 11
)
...
Food.create!(
  ...
  image: File.open('#{Rails.root}/public/seeds_image/スカイスパYOKOHAMA_フランスパンのアンチョビチーズ焼き.jpg'),
  user_id: 11
)
...
Food.create!(
  ...
  image: File.open('#{Rails.root}/public/seeds_image/ウェルビー栄_台湾もやしタワー.jpeg'),
  user_id: 2
)
...
Food.create!(
  ...
  image: File.open('#{Rails.root}/public/seeds_image/ウェルビー栄_手羽先.jpeg'),
  user_id: 9
)
...
Food.create!(
  ...
  image: File.open('#{Rails.root}/public/seeds_image/ウェルビー栄_朝食（無料）.jpeg'),
  user_id: 9
)
...
Food.create!(
  ...
  image: File.open('#{Rails.root}/public/seeds_image/サウナラボ_ソーセージマッカラ.jpg'),
  user_id: 14
)
...
Food.create!(
  ...
  image: File.open('#{Rails.root}/public/seeds_image/The Sauna_ラム麻婆ご飯.jpg'),
  user_id: 6
)
...
Food.create!(
  ...
  image: File.open('#{Rails.root}/public/seeds_image/スパ&カプセル ニューウイング_ちゃんこ鍋.jpg'),
  user_id: 6
)
...
Food.create!(
  ...
  image: File.open('#{Rails.root}/public/seeds_image/ニコーリフレ SAPPORO_味噌ラーメン.jpg'),
  user_id: 10
)
...
Food.create!(
  ...
  image: File.open('#{Rails.root}/public/seeds_image/ニコーリフレ SAPPORO_麻婆カツライス.jpg'),
  user_id: 10
)
...
Food.create!(
  ...
  image: File.open('#{Rails.root}/public/seeds_image/神戸サウナ&スパ_五目焼きそば.jpg'),
  user_id: 5
)
...
Food.create!(
  ...
  image: File.open('#{Rails.root}/public/seeds_image/サウナ&スパ カプセルホテル 大東洋_どて焼き.jpg'),
  user_id: 5
)
...
Food.create!(
  ...
  image: File.open('#{Rails.root}/public/seeds_image/ウェルビー福岡_無料朝ごはん.jpeg'),
  user_id: 2
)
...
Food.create!(
  ...
  image: File.open('#{Rails.root}/public/seeds_image/タイムズ スパ・レスタ_坦々麺.jpg'),
  user_id: 13
)
Food.create!(
  name: "ぶりしゃぶ",
  ...
  image: File.open('#{Rails.root}/public/seeds_image/スパ ラクーア_ぶりしゃぶ.jpg'),
  user_id: 3
)
# like
1.upto(17) do |n|
